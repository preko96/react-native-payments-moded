...
export default class PaymentRequest {
  ...
  _handleShippingAddressChange(postalAddress: PaymentAddress) {
    const { calledByDevice, ...actualPostalAddress } = postalAddress
    this._shippingAddress = actualPostalAddress;
    ...
    this._shippingAddressChangeFn(event, calledByDevice);
  }

  _handleShippingOptionChange({ selectedShippingOptionId, calledByDevice }: Object) {
    ...
    this._shippingOptionChangeFn(event, calledByDevice);
  }
